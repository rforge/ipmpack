              ...
              <tbody>
                <tr>
                  ...
                  <td width="400" valign="top">
                    ...
                    <p style="font-size:16px;line-height:1.25;text-align:justify"><br><b>Resources:</b><br><br>Subscribe to the <a href="http://lists.r-forge.r-project.org/cgi-bin/mailman/listinfo/ipmpack-users" rel="nofollow" style="color:#84002E;font-family:verdana" target="_blank">users email-list</a><br><br>Download the R package <a href="http://cran.r-project.org/web/packages/IPMpack/index.html" rel="nofollow" style="color:#84002E;font-family:verdana" target="_blank">IPMpack</a> (latest version: 2.0 (Jul'13). Since v2.0 IPMpack has among other things an improved sensParams function. Several other function are deprecated to come to a more consistent and simple naming of the functions in IPMpack. Warning messages will now appear when you use these deprecated functions. Please change these function names in your R code as indicated in the warning messages as these functions will discontinued in future versions of IPMpack.</p>
                  </td>
                  <td width="50px"></td>
                </tr>
              </tbody>
