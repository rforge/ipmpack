              ...
              <tbody>
                ...
                <tr style="background:#FFFFFF">
                  <td style="vertical-align:middle;padding:40px" width="420px">
                    ...
                    <p class="Refs">Caswell  H (2001) <b>Matrix Population Models: Analysis, Construction and Interpretation</b>. 2nd ed. Sinauer, Sunderland, Massachusetts, USA.<br><br></p>
					...
					<p class="Refs">Cochran ME & Ellner SP (1992) <b>Simple methods for calculating age-based life history parameters for stage-structured populations.</b> <i>Ecological Monographs</i> 62:345–364 <a href="http://dx.doi.org/10.2307/2937115" rel="nofollow" style="color:#84002E" target="_blank">doi</a>.<br><br></p>
					<p class="Refs">Ellner SP & Rees M (2006) <b>Integral projection models for species with complex life-histories.</b> <i>American Naturalist</i> 167:410-428.<br><br></p>
