...
growthModelComp <- function(dataf, 
	...
	# PLOT SECTION #
	if(makePlot == TRUE) {
		plotGrowthModelComp(dataf = dataf, expVars = expVars, grObj = grObj, summaryTable = summaryTable, plotLegend = TRUE, mainTitle)
	}
	return(outputList)
}
...
survModelComp <- function(dataf, 
	...
	if(makePlot == TRUE) {
		...
		plotSurvModelComp(dataf, svObj, expVars,  summaryTable, plotLegend = TRUE, mainTitle)
	}
	return(outputList)
}	
...
plotGrowthModelComp <- function(grObj, summaryTable, dataf, expVars, testType, respType = "sizeNext", plotLegend = TRUE, mainTitle = "") {
	treatN <- length(grObj)
...
plotSurvModelComp <- function( svObj, dataf, treatN, testType, expVars, summaryTable, plotLegend = TRUE, mainTitle = "") {
	treatN <- length(svObj)
